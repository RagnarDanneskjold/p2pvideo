...
var ChatFactory = typeof p2pvideo === 'undefined' ? require('soop').load('../js/models/core/ChatFactory',{
  Network: FakeNetwork,
  Blockchain: Insight,
  Storage: FakeStorage,
...
describe('ChatFactory model', function() {
  var config = {
    chat: {
  ...
  describe('factory', function() {
    ...
    it('should be able to create chats', function() {
      var wf = new ChatFactory(config);
      var w = wf.create();
      should.exist(w);
    });
    it('should be able to get chats', function() {
      var wf = new ChatFactory(config);
      var w = wf.create();
    ...
    it('#fromObj #toObj round trip', function() {
      ...
      should.exist(w.publicKeyRing.getp2pvideoerId);
