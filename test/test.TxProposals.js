...
var fakeStorage    = p2pvideo.FakeStorage;
var PrivateKey    = p2pvideo.PrivateKey || require('../js/models/PrivateKey');
var TxProposals    = p2pvideo.TxProposals || require('../js/models/TxProposal');
var PublicKeyRing  = is_browser ? p2pvideo.PublicKeyRing :
...
var createPKR = function (bip32s) {
  ...
  for(var i=0; i<5; i++) {
    if (bip32s) {
      var b=bip32s[i];
      w.addp2pvideoer(b?b.getExtendedPublicKeyString():null);
    }
    else 
      w.addp2pvideoer();
  }
